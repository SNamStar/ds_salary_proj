...
Author: Paul(Seong) Nam
"""
'''This Selenium was made by Omar Sakarya https://github.com/arapfaik/scraping-glassdoor-selenium
'''
...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
    ...
    #url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword=' + keyword + '&locT=C&locId=1150505&locKeyword=Seattle,%20WA&srs=RECENT_SEARCHES'
